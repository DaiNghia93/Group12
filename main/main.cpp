...
static void IRAM_ATTR button_isr_handler(void* arg) {
    ...
    static int last_level = 1;   // pull-up -> mặc định HIGH
...
void control_task(void *pv) {
    ...
    while (1) {
        ...
        // ===== AUTO MODE =====
        if (xQueueReceive(ai_queue, &ai_data, 0)) {
...
extern "C" void app_main(void) {
    ...
    io_conf.intr_type = GPIO_INTR_ANYEDGE;   // 🔥 dùng ANYEDGE
